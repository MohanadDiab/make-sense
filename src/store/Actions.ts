export enum Action {
    ...
    UPDATE_DUAL_VIEW_ENABLED = '@@UPDATE_DUAL_VIEW_ENABLED',
    UPDATE_DUAL_VIEW_SYNC_ENABLED = '@@UPDATE_DUAL_VIEW_SYNC_ENABLED',
    UPDATE_DUAL_VIEW_SYNC_DIRECTION = '@@UPDATE_DUAL_VIEW_SYNC_DIRECTION',
    UPDATE_DUAL_VIEW_SYNC_CONFLICT_POLICY = '@@UPDATE_DUAL_VIEW_SYNC_CONFLICT_POLICY',
